...
add_filter( 'gettext', 'faithmade_replace_wordpress' );
...
add_filter( 'gettext', 'faithmade_replace_wordpress_xhtml' );
...
add_filter( 'gettext', 'faithmade_replace_wordpress_comment_contains1' );
...
add_filter( 'gettext', 'faithmade_replace_wordpress_comment_contains2' );
...
add_filter( 'gettext', 'faithmade_replace_wordpress_permalink' );
